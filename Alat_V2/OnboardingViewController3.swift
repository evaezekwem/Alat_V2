...
class OnboardingViewController3: UIViewController {
    ...
    let iconImageView: UIImageView = {
        let image = UIImageView(image: UIImage(named: "onboarding_img_3"))
        image.translatesAutoresizingMaskIntoConstraints = false
    ...
    func setupImageAndMessageContainerView() {
        ...
        imageAndMessageContainerView.centerYAnchor.constraint(equalTo: view.centerYAnchor).isActive = true
        imageAndMessageContainerView.widthAnchor.constraint(equalTo: view.widthAnchor, constant: -80).isActive = true
        imageAndMessageContainerView.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.5).isActive = true
    }
    ...
    func setupSkipButton() {
        ...
        skipButton.topAnchor.constraint(equalTo: imageAndMessageContainerView.bottomAnchor, constant: 60).isActive = true
